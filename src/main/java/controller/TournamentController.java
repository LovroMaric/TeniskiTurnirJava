...
public class TournamentController {
    ...
    private final TournamentService tournamentService = AppContext.getTournamentService();

    private final PlayerService playerService = AppContext.getPlayerService();

    private final TournamentXmlService xmlService = new TournamentXmlService();

    private final CategoryService categoryService = AppContext.getCategoryService();
    ...
    private void initDragAndDrop() {
        ...
        tournamentTable.setOnDragDropped(event -> {
            ...
            Tournament selected =
                    tournamentTable.getSelectionModel().getSelectedItem();
            ...
            if (db.hasString() && selected != null) {
                ...
                try {
                    ...
                    tournamentService.addPlayerToTournament(
                            selected.getId(),
                            playerId,
                            "N/A"
                    );
